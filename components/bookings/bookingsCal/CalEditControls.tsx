...
function ButtonCheck(props: any) {
  return (
    ...
    >
      <Icon icon="bookmark" className="h-12 w-12 fill-lime-700 p-2" />
    </button>
  );
}
...
function ButtonXMark(props: any) {
  return (
    ...
    >
      <Icon
        icon="bookmark"
        className="absolute h-10 w-10 fill-orange-900/50 p-2"
      />
      <Icon icon="noSymbol" className="h-20 w-20 fill-orange-900/75" />
    </button>
  );
}
