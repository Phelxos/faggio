...
function ButtonXMark() {
  return (
    <button className="flex flex-col items-center justify-center rounded-full border-4 border-rose-700/75 bg-[radial-gradient(ellipse_at_top_left,_var(--tw-gradient-stops))] from-red-200 to-red-500 drop-shadow-xl duration-200 ease-in-out hover:border-rose-900 active:translate-y-0.5 active:drop-shadow-md">
